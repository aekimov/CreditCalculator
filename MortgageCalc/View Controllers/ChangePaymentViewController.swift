//
//  ChangePaymentViewController.swift
//  MortgageCalc
//
...
class ChangePaymentViewController: UIViewController {
   
    private(set) var viewModel: ChangePaymentViewModel
    
    init(viewModel: ChangePaymentViewModel) {
    ...
    private let addAdvancePaymentButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(handleSavePayment), for: .touchUpInside)
        return button
    }()
...
private extension ChangePaymentViewController {
...
extension ChangePaymentViewController {
